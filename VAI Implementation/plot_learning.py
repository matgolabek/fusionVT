...
parser.add_argument("-d", type=str, default="logs/log_025.txt", help="path to log file")
...
plt.figure(figsize=(10, 6))
plt.step(epochs, mAPDatabase[:epo_max, 0], label='class0', color='#e01616')
plt.step(epochs, mAPDatabase[:epo_max, 1], label='class1', color="#f2d777")
plt.step(epochs, mAPDatabase[:epo_max, 2], label='class2', color='#83db18')
plt.step(epochs, mAPDatabase[:epo_max, 3], label='class3', color='#c714af')
